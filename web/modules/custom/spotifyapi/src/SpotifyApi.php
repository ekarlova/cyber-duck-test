...
class SpotifyApi {
  ...
  public function getArtists($artist) {
    ...
    try {
      $response = $this->httpClient->request('GET', self::SPOTIFY_API_BASE_URL . "/v1/artists/", [
        'headers' => [
          'Authorization' => 'Bearer ' . $auth_token
        ],
        'query' => [
      ...
      $this->messenger->addMessage('Unable to get artists: ' . $e->getMessage(), MessengerInterface::TYPE_ERROR);
      return [];
    }
